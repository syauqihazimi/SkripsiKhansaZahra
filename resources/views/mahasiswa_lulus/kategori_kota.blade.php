                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Jumlah Mahasiswa Lulus Berdasarkan Kategori Kota /</h4>
                                <h4 class="float-right"><a href="{{ route('jumlah_mahasiswa_lulus_kota') }}">Jumlah Mahasiswa Lulus Berdasarkan Kota</a></h4>
                            </div>
                            <form method="GET" action="{{ route('jumlah_mahasiswa_lulus_kategori_kota') }}" id="filter-form">
                                @csrf
                                <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        if (query.length > 0) {
            var labels = query.map(item => item.kategori_kota);
