                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Jumlah Mahasiswa Berdasarkan Lulus Kategori Tahun Lulus /</h4>
                                <h4 class="float-right"><a href="{{ route('jumlah_mahasiswa_lulus_tahun_lulus') }}">Jumlah Mahasiswa Lulus Berdasarkan Tahun Lulus</a></h4>
                            </div>
                            <form method="GET" action="{{ route('jumlah_mahasiswa_lulus_kategori_lulus') }}" id="filter-form">
                                @csrf
                                <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        if (query.length > 0) {
            var labels = query.map(item => item.kategori_lulus);
