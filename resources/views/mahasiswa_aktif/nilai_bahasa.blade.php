                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Jumlah Mahasiswa Aktif Berdasarkan Nilai Bahasa</h4>
                            </div>
                            <form method="GET" action="{{ route('jumlah_mahasiswa_aktif_nilai_bahasa') }}" id="filter-form">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="nilai_bahasa" id="nilai_bahasa" class="form-control">
                                            <option value="">Pilih Nilai Bahasa</option>
                                            <option value="toefl" {{ request('nilai_bahasa') == 'etic' ? 'selected' : '' }}>TOEFL</option>
                                            <option value="toafl" {{ request('nilai_bahasa') == 'toafl' ? 'selected' : '' }}>TOAFL</option>
                                        </select>
                                    </div>
...
<script>
   $(document).ready(function() {
    ...
    if (query && (query.jumlah_mahasiswa_lulus !== undefined || query.jumlah_mahasiswa_tidak_lulus !== undefined)) {
        var labels = ['Lulus', 'Tidak Lulus'];
        var data = [query.jumlah_mahasiswa_lulus, query.jumlah_mahasiswa_tidak_lulus];
        ...
        const myChart = new Chart(ctx2, {
            ...
            options: {
                ...
                scales: {
                    x: {
                        min: 0,
                        max: 1, // Hanya dua label yang tersedia
                        ticks: {
                            font: {
                                size: 14,
                                weight: 'bold'
