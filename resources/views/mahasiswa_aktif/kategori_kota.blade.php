                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Jumlah Mahasiswa Aktif Berdasarkan Kategori Kota /</h4>
                                <h4 class="float-right"><a href="{{ route('jumlah_mahasiswa_lulus_kota') }}">Jumlah Mahasiswa Aktif Berdasarkan Kota</a></h4>
                            </div>
                            <form method="GET" action="{{ route('jumlah_mahasiswa_aktif_kategori_kota') }}" id="filter-form">
                                @csrf
                                <div class="card-body">
