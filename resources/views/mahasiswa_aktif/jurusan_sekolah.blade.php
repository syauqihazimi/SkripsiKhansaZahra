                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Jumlah Mahasiswa Aktif Berdasarkan Jurusan Sekolah</h4>
                            </div>
                            <form method="GET" action="{{ route('jumlah_mahasiswa_aktif_jurusan_sekolah') }}" id="filter-form">
                                @csrf
                                <div class="card-body">
...
<script>
    $(document).ready(function() {
        ...
        if (query.length > 0) {
            var labels = query.map(item => item.jurusan_sekolah);
